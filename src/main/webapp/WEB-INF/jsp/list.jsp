                    ...
                    <ul class="page-sidebar-menu" id="page-sidebar-menu">
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu">
                                ...
                                <shiro:hasPermission name="user:admin_login">
                                    <li>
                                        <a href="javascript:;">user:admin_login 拥有此权限</a>
                                    </li>
                                </shiro:hasPermission>
                                
                                <shiro:hasPermission name="user:client_login">
                                    <li>
                                        <a href="javascript:;">user:client_login 拥有此权限</a>
                                    </li>
                                </shiro:hasPermission>
                                <shiro:hasPermission name="user:client_admin">
                                    <li>
                                        <a href="javascript:;">user:client_admin 拥有此权限</a>
                                    </li>
                                </shiro:hasPermission>
